...
var def_SpAnimCtrl = function (t) {
  ...
  _ctor.prototype.playAnimWithFrame = function (t, e, n, i, o) {
    undefined === e && (e = false);
    undefined === n && (n = 0);
    ...
    if (this.node.active) {
      ...
      if (a) {
        ...
        var p = Math.min(i / 60, 1);
        var l = this.spAnim.setAnimation(0, t, e);
  ...
  _ctor.prototype.playAnim = function (t, e, n, i) {
    undefined === e && (e = 1);
    undefined === n && (n = false);
    if (!this.spAnim) {
      return null;
  ...
  _ctor.prototype.playAnimFixSpeed = function (t, e, n, i) {
    undefined === e && (e = 1);
    undefined === n && (n = false);
    if (!this.spAnim) {
      return null;
  ...
  return cc__decorate([ccp_ccclass, ccp_menu("Utils/Components/SpAnimCtrl")], _ctor);
}(cc.Component);
exports.default = def_SpAnimCtrl;