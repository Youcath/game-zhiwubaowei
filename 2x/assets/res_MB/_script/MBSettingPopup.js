...
var def_MBSettingPopup = function (t) {
  function _ctor() {
  ...
  _ctor.prototype.onClickBtnBack = function () {
    if ($10MBScene.default.instance.isRounding) {
      $10GameUIManager.gameUIMgr.showTips("回合结束后才能退出");
    } else {
...
exports.default = def_MBSettingPopup;