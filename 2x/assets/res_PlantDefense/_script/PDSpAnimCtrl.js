...
var def_PDSpAnimCtrl = function (t) {
  function _ctor() {
  ...
  _ctor.prototype.playAnimWithFrame = function (t, e, n, o, i) {
    undefined === e && (e = false);
    undefined === n && (n = 0);
    undefined === o && (o = Number.MAX_SAFE_INTEGER);
    undefined === i && (i = 1);
    if (!this.spAnim) {
      return null;
    }
    if (this.node.active) {
      var a = this.spAnim.findAnimation(t);
      if (a) {
        var r = a.duration;
        var s = Math.ceil(60 * r);
        o = Math.min(o, s);
        var l = Math.max(0, n / 60);
        var c = Math.min(o / 60, 1);
        var p = this.spAnim.setAnimation(0, t, e);
        this.spAnim.timeScale = 0;
        p.animationStart = l;
        p.animationEnd = c;
        this.spAnim.timeScale = i;
        this._timeScale = this.spAnim.timeScale;
        return p;
      }
    }
  };
  _ctor.prototype.playAnim = function (t, e, n, o) {
    undefined === e && (e = 1);
    undefined === n && (n = false);
    if (!this.spAnim) {
      return null;
    ...
    if (this.node.active) {
      ...
      if (!this.spAnim.isAnimationCached()) {
        var i = this.spAnim.getCurrent(0);
        if (i && i.animation.name == t) {
          return null;
        }
      ...
      this._timeScale = this.spAnim.timeScale;
      this.onceOnComplete = o;
      this._onPlayAnimFunc && this._onPlayAnimFunc(t, e, n);
      return this.spAnim.setAnimation(0, t, n);
    }
  };
  _ctor.prototype.playAnimFixSpeed = function (t, e, n, o) {
    undefined === e && (e = 1);
    undefined === n && (n = false);
    if (!this.spAnim) {
      return null;
  ...
  _ctor.prototype.onFrameEvent = function (t, e) {
    var n = this;
    this.animFrameEventListener.forEach(function (o, i) {
      o.call(i, t.animation.name, e.data.name, n);
    });
  };
  ...
  _ctor.prototype.generateSomeNodes = function (t, e) {
    ...
    if (e) {
      return e instanceof cc.Prefab ? n.addChild(cc.instantiate(e)) : e.parent ? e.parent = n : n.addChild(e), n;
    } else {
      return n;
    }
  };
...
exports.default = def_PDSpAnimCtrl;