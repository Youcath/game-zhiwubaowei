...
var def_STSpAnimCtrl = function (t) {
  function _ctor() {
  ...
  _ctor.prototype.playAnimWithFrame = function (t, e, o, i, n) {
    undefined === e && (e = false);
    undefined === o && (o = 0);
  ...
  _ctor.prototype.playAnim = function (t, e, o, i) {
    ...
    if (this.node.active) {
      ...
      if (!this.spAnim.isAnimationCached()) {
        var n = this.spAnim.getCurrent(0);
        if (n && n.animation.name == t) {
          return null;
        }
  ...
  _ctor.prototype.onFrameEvent = function (t, e) {
    var o = this;
    this.animFrameEventListener.forEach(function (i, n) {
      i.call(n, t.animation.name, e.data.name, o);
    });
  };
...
exports.default = def_STSpAnimCtrl;