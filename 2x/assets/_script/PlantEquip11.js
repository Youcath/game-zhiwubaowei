...
var def_PlantEquip11 = function (t) {
    ...
    if (this.getCollisionIsValid()) {
      ...
      if (this.addSuperTriggerCounter()) {
          ...
          if (++n == Math.ceil(o / 2)) {
            ...
            for (var a = 0; a < t.length; ++a) {
              ...
              if (s && s.isValid && e.getIsAtk(i, s)) {
                ...
                s.getComponent($10EnemyBase.default).ice();
              }
            }
          }
        };
        for (var l = 0; l < o; ++l) {
          ...
          _.getComponent($10BulletBase.default).initBullet(this.mEquipId, this._atkTarget, this._level, this._atkCount, this._isRage);
          _.getComponent($10BulletBase.default).setAtkPos(cc.v3(y, g));
          _.getComponent($10SuperBulletPlant11.default).startMove(function () {
  ...
  _ctor.prototype.openFire = function () {
    if (this._atkTarget && this._atkTarget.isValid) {
      ...
      o.getComponent($10BulletBase.default).initBullet(this.mEquipId, this._atkTarget, this._level, this._atkCount, this._isRage);
      o.getComponent($10BulletBase.default).setAtkPos(cc.v3(t, e));
      o.getComponent($10BulletPlant11.default).startMove(this._atkTarget);
    }
  };
...
exports.default = def_PlantEquip11;