...
var def_GameWinPopup = function (t) {
  function _ctor() {
  ...
  _ctor.prototype.init = function (e) {
    ...
    $10AudioManager.AudioManager.instance.playEffectPath("sounds/win", $10HomeEnum.Bundles.RES);
  ...
  _ctor.prototype.weatherOver = function () {
    ...
    if (e) {
      ...
      var a = function (t) {
        var e = n[t].split("_");
        if ((i = Math.floor(1 * Number(e[1]))) > 0) {
    ...
    if (t > $10UserDataProxy.userDataProxy.userData.passWeatherChapter) {
      $10UserDataProxy.userDataProxy.userData.passWeatherChapter = t;
      var c = $10DataManager.DataManager.instance.eData.data_weather;
      var l = 0;
      var u = Object.keys(c);
      var p = c[u[u.length - 1]];
      p && (l = p.stage);
      $10UserDataProxy.userDataProxy.userData.passWeatherChapter < l && ($10UserDataProxy.userDataProxy.userData.cursWeatherChapter = $10UserDataProxy.userDataProxy.userData.passWeatherChapter + 1);
  ...
  _ctor.prototype.chapterOver = function () {
    ...
    var t = $10BattleDataProxy.battleDataProxy.getStageRewardCfg().winReward.split("|");
    var e = [];
    var o = 0;
    var i = 0;
    for (var n = t.length; i < n; i++) {
      var a = t[i].split("_");
      (o = Math.floor(1 * Number(a[1]))) > 0 && e.push({
        id: Number(a[0]),
        num: o
      });
    }
    this.setRewardItems(e);
    var r = $10UserDataProxy.userDataProxy.userData.curChapter;
    if (r > $10UserDataProxy.userDataProxy.userData.passChapter) {
      $10UserDataProxy.userDataProxy.userData.passChapter = r;
      var s = $10DataManager.DataManager.instance.eData.datastagereward;
      var l = 0;
      for (var u in s) {
        l = s[u].id;
      }
      $10UserDataProxy.userDataProxy.userData.passChapter < l && ($10UserDataProxy.userDataProxy.userData.curChapter = $10UserDataProxy.userDataProxy.userData.passChapter + 1);
      $10UserDataProxy.userDataProxy.userData.passWave = 0;
      var p = new Date();
      var h = $10TimeUtil.TimeUtil.getCalendarDaysBetweenTimestamps($10DataManager.DataManager.instance.mCreateTime, p.getTime()) + 1;
      mm.platform.umaTrackEvent("progress", {
        userA: "lv_until_" + h + "_" + $10UserDataProxy.userDataProxy.userData.curChapter
      });
      $10UserDataProxy.userDataProxy.saveData();
    }
    var d = $10DataManager.DataManager.instance.eData.dataplant;
    for (var u in d) {
      var g = d[u];
      g.stageID == r && ($10UserDataProxy.userDataProxy.getIsUnlockPlant(g.id) || $10UserDataProxy.userDataProxy.mNewUnlockPlantIds.push(g.id));
    }
    this._reawards = e;
  };
...
exports.default = def_GameWinPopup;