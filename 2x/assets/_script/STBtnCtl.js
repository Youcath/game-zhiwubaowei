...
var def_STBtnCtl = function (t) {
  ...
  _ctor.prototype.updateView = function () {
    if ($10DataManager.DataManager.instance.isSubGameOpen($10HomeEnum.ESubGameSwitch.ST)) {
  ...
  _ctor.prototype.updateUnlock = function () {
    var t = Number($10DataManager.DataManager.instance.eData.datapara[1901].num);
    ...
    this.node.getChildByName("txt").getComponent(cc.Label).string = "敲罐子";
  ...
  _ctor.prototype.updateTime = function () {
    ...
    e.active = false;
    var o = $10STJDataProxy.sTJDataProxy.STJData.btnStartTime;
    if (o > 0) {
      var i = 6e4 * Number($10DataManager.DataManager.instance.eData.datapara[1902].num);
      ...
      this.schedule(function () {
        if ((a = $10Util.default.getTimeLeftTime(o, i)) <= 0) {
          ...
          $10STJDataProxy.sTJDataProxy.STJData.btnStartTime = 0;
  ...
  _ctor.prototype.onEnterMiniGame = function () {
    var t = this;
    var e = Number($10DataManager.DataManager.instance.eData.datapara[1901].num);
    if ($10UserDataProxy.userDataProxy.userData.passChapter >= e) {
      if ($10STJDataProxy.sTJDataProxy.STJData.btnStartTime > 0) {
        $10AdsMgr.default.showVideoAds({
          id: 1,
          eventId: "st_game_enter",
          success: function () {
            $10STJDataProxy.sTJDataProxy.STJData.btnStartTime = 0;
  ...
  _ctor.prototype.openShootSelectPopup = function () {
    $10PopupManager.PopupManager.instance.show({
      ...
      path: "prefabs/popups/STSelectPopup"
    });
  };
  return cc__decorate([ccp_ccclass], _ctor);
}(cc.Component);
exports.default = def_STBtnCtl;