...
var def_PDBtnCtl = function (t) {
  ...
  _ctor.prototype.updateView = function () {
    if ($10DataManager.DataManager.instance.isSubGameOpen($10HomeEnum.ESubGameSwitch.PD)) {
  ...
  _ctor.prototype.updateUnlock = function () {
    ...
    this.node.getChildByName("txt").getComponent(cc.Label).string = "战僵尸";
  ...
  _ctor.prototype.updateTime = function () {
    ...
    e.active = false;
    var o = $10PlantDefenseDataProxy.plantDefenseDataProxy.PlantDefenseData.btnStartTime;
    if (o > 0) {
      ...
      this.schedule(function () {
        if ((a = $10Util.default.getTimeLeftTime(o, i)) <= 0) {
          ...
          $10PlantDefenseDataProxy.plantDefenseDataProxy.PlantDefenseData.btnStartTime = 0;
  ...
  _ctor.prototype.onEnterMiniGame = function () {
    ...
    if ($10UserDataProxy.userDataProxy.userData.passChapter >= e) {
      if ($10PlantDefenseDataProxy.plantDefenseDataProxy.PlantDefenseData.btnStartTime > 0) {
  ...
  _ctor.prototype.openShootSelectPopup = function () {
    $10PlantDefenseDataProxy.plantDefenseDataProxy.gameMode = $10PlantDefenseDataProxy.PDGameMode.PD_GAME;
