...
var def_GTBtnCtl = function (t) {
  ...
  _ctor.prototype.updateView = function () {
    if ($10DataManager.DataManager.instance.isSubGameOpen($10HomeEnum.ESubGameSwitch.GT)) {
  ...
  _ctor.prototype.updateUnlock = function () {
    var t = Number($10DataManager.DataManager.instance.eData.datapara[901].num);
    ...
    this.node.getChildByName("txt").getComponent(cc.Label).string = "家园守卫";
  ...
  _ctor.prototype.updateTime = function () {
    ...
    e.active = false;
    var o = $10GuardingDataProxy.guardingDataProxy.GuardingData.btnStartTime;
    if (o > 0) {
      var i = 6e4 * Number($10DataManager.DataManager.instance.eData.datapara[902].num);
      ...
      this.schedule(function () {
        if ((a = $10Util.default.getTimeLeftTime(o, i)) <= 0) {
          ...
          $10GuardingDataProxy.guardingDataProxy.GuardingData.btnStartTime = 0;
  ...
  _ctor.prototype.onEnterMiniGame = function () {
    var t = this;
    var e = Number($10DataManager.DataManager.instance.eData.datapara[901].num);
    if ($10UserDataProxy.userDataProxy.userData.passChapter >= e) {
      if ($10GuardingDataProxy.guardingDataProxy.GuardingData.btnStartTime > 0) {
        $10AdsMgr.default.showVideoAds({
          id: 1,
          eventId: "gt_game_enter",
          success: function () {
            t.enterGame();
          },
          fail: function () {},
  ...
  _ctor.prototype.enterGame = function () {
    ...
    $10SceneManager.SceneManager.instance.runScene("GuardingTheBridge", "res_GuardingTheBridge");
  };
  return cc__decorate([ccp_ccclass], _ctor);
}(cc.Component);
exports.default = def_GTBtnCtl;