...
var def_BulletPlant6 = function (t) {
  function _ctor() {
  ...
  _ctor.prototype.startMove = function (t) {
    ...
    var o;
    var i = this;
    null === (e = t.getComponent($10EnemyBase.default)) || undefined === e || e.initSimulationData();
    var n = $10MathUtil.MathUtil.distance(this.node.position, this._atkPos.clone()) / (30 * this._moveSpd);
    this._atkPos = (null === (o = t.getComponent($10EnemyBase.default)) || undefined === o ? undefined : o.getMovePosByTime(n)) || t.position.clone();
  ...
  _ctor.prototype.moveArrive = function (e) {
    ...
    var o = this.addBulletHit(e);
    t.prototype.moveArrive.call(this, e);
    o && o.isValid && (o.angle = this.node.angle);
  };
  ...
  _ctor.prototype.initAtkPos = function () {};
  return cc__decorate([ccp_ccclass], _ctor);
}($10BulletBase.default);
exports.default = def_BulletPlant6;