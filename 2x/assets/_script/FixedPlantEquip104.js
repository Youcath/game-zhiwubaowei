...
var $10SuperBulletPlant2 = require("SuperBulletPlant2");
var $10FixedPlantEquipBase = require("FixedPlantEquipBase");
var cc__decorator = cc._decorator;
var ccp_ccclass = cc__decorator.ccclass;
cc__decorator.property;
var def_FixedPlantEquip104 = function (t) {
  function _ctor() {
  ...
  _ctor.prototype.openFire = function () {
    if (this._atkTarget && this._atkTarget.isValid) {
      ...
      t.getComponent($10SuperBulletPlant2.default).initFixedPlantBullet(o, this._atkTarget, Number(this._fixedPlantData.num));
    }
  };
  return cc__decorate([ccp_ccclass], _ctor);
}($10FixedPlantEquipBase.default);
exports.default = def_FixedPlantEquip104;