...
var def_EndlessOverPopup = function (t) {
  function _ctor() {
  ...
  _ctor.prototype.init = function (e) {
    ...
    this.mWaveNum.string = "本次波次:" + $10BattleDataProxy.battleDataProxy.endlessCurWave;
    var o = this.node.getChildByName("pic_xinjilu");
    if ($10BattleDataProxy.battleDataProxy.endlessCurWave > $10UserDataProxy.userDataProxy.userData.endlessData.maxWave) {
      $10UserDataProxy.userDataProxy.userData.endlessData.maxWave = $10BattleDataProxy.battleDataProxy.endlessCurWave;
      o.active = true;
    } else {
      o.active = false;
    }
    this.mMaxWave.string = "今日最高波次：" + $10UserDataProxy.userDataProxy.userData.endlessData.maxWave;
    this.endlessOver();
    ...
    this.mTips2.string = $10DataManager.DataManager.instance.eData.datasettlement[2]["des" + i];
  ...
  cc__decorate([ccp_property(cc.Label)], _ctor.prototype, "mWaveNum", undefined);
...
exports.default = def_EndlessOverPopup;