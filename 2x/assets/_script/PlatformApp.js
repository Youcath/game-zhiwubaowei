...
exports.PlatformApp = exports.EditInputParams = undefined;
...
var exp_PlatformApp = function () {
  function _ctor() {
    this.versionStr = "1.0.0";
    this.versionCode = 100;
    this.adUintId = {};
    console.log("运行环境：app");
  }
  var e;
  e = _ctor;
  ...
  _ctor.prototype.startVibrate = function (t) {
    ...
    switch (cc.sys.os) {
      case "Android":
        if (t) {
          jsb.reflection.callStaticMethod("org/cocos2dx/javascript/Utils", "vibrateLong", "()V");
        } else {
          jsb.reflection.callStaticMethod("org/cocos2dx/javascript/Utils", "vibrateShort", "()V");
        }
    }
  };
  _ctor.prototype.review = function () {
    switch (cc.sys.os) {
      case "Android":
        jsb.reflection.callStaticMethod("org/cocos2dx/javascript/Utils", "review", "()V");
    }
  };
  ...
  _ctor.prototype.showVideoAds = function (t) {
    if (yzll.gameConfig.isTest || yzll.gameConfig.isGM) {
      ...
      switch (cc.sys.os) {
        case "Android":
          var o = jsb.reflection.callStaticMethod("org/cocos2dx/javascript/AdsMgr", "videoIsReady", "()Z");
          console.log("zb hasReward", o);
          if (o) {
            cc.game.pause();
            jsb.reflection.callStaticMethod("org/cocos2dx/javascript/AdsMgr", "showVideo", "()V");
          }
          break;
        case "iOS":
...
exports.PlatformApp = exp_PlatformApp;
window.PlatformApp = exp_PlatformApp;