...
var def_SJBtnCtl = function (t) {
  ...
  _ctor.prototype.updateView = function () {
    if ($10DataManager.DataManager.instance.isSubGameOpen($10HomeEnum.ESubGameSwitch.SJ)) {
  ...
  _ctor.prototype.updateUnlock = function () {
    var t = Number($10DataManager.DataManager.instance.eData.datapara[101].num);
    ...
    this.node.getChildByName("txt").getComponent(cc.Label).string = "随机植物";
  ...
  _ctor.prototype.updateTime = function () {
    ...
    e.active = false;
    var o = $10PlantDefenseDataProxy.plantDefenseDataProxy.PlantDefenseData.btnStartTime2;
    if (o > 0) {
      var i = 6e4 * Number($10DataManager.DataManager.instance.eData.datapara[102].num);
      ...
      this.schedule(function () {
        if ((a = $10Util.default.getTimeLeftTime(o, i)) <= 0) {
          ...
          $10PlantDefenseDataProxy.plantDefenseDataProxy.PlantDefenseData.btnStartTime2 = 0;
  ...
  _ctor.prototype.onEnterMiniGame = function () {
    var t = this;
    var e = Number($10DataManager.DataManager.instance.eData.datapara[101].num);
    if ($10UserDataProxy.userDataProxy.userData.passChapter >= e) {
      if ($10PlantDefenseDataProxy.plantDefenseDataProxy.PlantDefenseData.btnStartTime2 > 0) {
        $10AdsMgr.default.showVideoAds({
          id: 1,
          eventId: "pd_game_enter",
          success: function () {
            $10PlantDefenseDataProxy.plantDefenseDataProxy.PlantDefenseData.btnStartTime2 = 0;
            $10PlantDefenseDataProxy.plantDefenseDataProxy.saveData();
            t.openShootSelectPopup();
          },
          fail: function () {},
          error: function (t) {
            cc.log(t);
        ...
        this.openShootSelectPopup();
      }
    } else {
      $10GameUIManager.gameUIMgr.showTips("第" + e + "章解锁!");
    }
  };
  _ctor.prototype.openShootSelectPopup = function () {
    $10PlantDefenseDataProxy.plantDefenseDataProxy.gameMode = $10PlantDefenseDataProxy.PDGameMode.SJ_GAME;
    $10PopupManager.PopupManager.instance.show({
      bundleName: $10HomeEnum.Bundles.PlantDefense,
      path: "prefabs/popups/PDSelectPopup"
    });
  };
  return cc__decorate([ccp_ccclass], _ctor);
}(cc.Component);
exports.default = def_SJBtnCtl;