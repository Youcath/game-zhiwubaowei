...
var def_GTWinPopup = function (t) {
  ...
  _ctor.prototype.init = function (e) {
    ...
    this._reawards = o;
    var n = $10DataManager.DataManager.instance.eData.data_bridgestage[46];
    if (n) {
      var s = n.reward.split("|");
    ...
    var m = function (t) {
      ...
      var i = g.mItemLayout.children[t];
      i || ((i = cc.instantiate(g.mItemLayout.children[0])).parent = g.mItemLayout);
      i.active = true;
    ...
    var r = function (n) {
      ...
      s.scheduleOnce(function () {
        if (c) {
          ...
          $10UserDataProxy.userDataProxy.addProp(c.id, c.num, i + 1 == a);
        }
      }, .1 * i);
      i++;
    };
...
exports.default = def_GTWinPopup;