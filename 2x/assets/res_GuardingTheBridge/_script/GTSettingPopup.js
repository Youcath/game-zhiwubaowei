...
var def_GTSettingPopup = function (t) {
  function _ctor() {
  ...
  _ctor.prototype.init = function () {
    $10GuardingDataProxy.guardingDataProxy.gameState == $10GameEnum.GameState.PLAYING && ($10GuardingDataProxy.guardingDataProxy.gameState = $10GameEnum.GameState.PAUSE);
  ...
  _ctor.prototype.onClickBtnClose = function () {
    $10GuardingDataProxy.guardingDataProxy.gameState == $10GameEnum.GameState.PAUSE && ($10GuardingDataProxy.guardingDataProxy.gameState = $10GameEnum.GameState.PLAYING);
    this.removeUI();
  };
...
exports.default = def_GTSettingPopup;